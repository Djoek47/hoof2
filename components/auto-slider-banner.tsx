    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center">
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-gray-100 text-center mb-4">
          Official Faberland Merch
        </h1>
        <p className="text-xl text-gray-300 text-center mb-8">Wear Your Metaverse Identity</p>
        <Button
          onClick={handleShopClick}
          size="lg"
          className="bg-yellow-500 hover:bg-yellow-600 text-dark-900 border-none"
        >
          SHOP NOW
        </Button>
      </div>
