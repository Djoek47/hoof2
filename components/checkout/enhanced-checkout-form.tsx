  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedPaymentMethod === "stripe") {
        ...
        setSuccessOrderId(result.order.external_id)
        setSuccessMethod("manual")
      ...
      <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
        <DialogContent className="max-w-md mx-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {successMethod === "stripe"
                ? "Payment Approved. Thank you for shopping with us! Your payment has been processed and your order is being prepared."
                : "Order Created. Thank you for your order! A payment link will be sent to your email for manual payment."}
              {successOrderId && (
                <>
                  <br />
                  <span className="text-xs text-gray-400">
                    <strong>Order ID:</strong> {successOrderId}
                  </span>
                </>
              )}
            </DialogDescription>
          ...
          <div className="flex gap-2 mt-4">
            ...
            <Button className="flex-1" variant="outline" onClick={() => { setShowSuccessModal(false); window.location.href = "/"; }}>
              Continue Shopping
            </Button>
          </div>
        </DialogContent>
